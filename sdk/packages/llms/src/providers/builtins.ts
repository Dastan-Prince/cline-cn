...
const OPENAI_COMPATIBLE_SPEC_OVERRIDES: BuiltinSpecOverride[] = [
	...
	},
	{
		...
		capabilities: ["prompt-cache", "tools", "reasoning"],
		defaultModelId: "mimo-v2.5",
		apiKeyEnv: ["XIAOMI_ATHRAPI_API_KEY"],
		modelsProviderId: "xiaomi",
		defaults: { baseUrl: "https://api.xiaomimimo.com/anthropic" },
	},
	{
		...
		apiKeyEnv: ["XIAOMI_TP_ATHRAPI_API_KEY"],
		modelsProviderId: "xiaomi",
		defaults: { baseUrl: "https://token-plan-cn.xiaomimimo.com/anthropic" },
	},
	{
		id: "zhipu-athrapi",
		name: "Zhipu AthrAPI",
	...
	},
	{
		...
		id: "dots-studio",
		name: "Dots Studio",
		description: "通过 OpenAI 兼容端点访问的 Dots Studio 模型",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
	...
	},
	{
		...
		protocol: "anthropic",
		capabilities: ["prompt-cache", "tools", "reasoning"],
		apiKeyEnv: ["ANTHROPIC_COMP_API_KEY"],
		modelsProviderId: "anthropic-comp",
	},
	{
		id: "kilo",
		name: "Kilo Gateway",
