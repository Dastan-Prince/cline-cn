			...
			{otelEnabled && (
				<div className="flex gap-2 flex-wrap">
					<TestButton
						...
						successMessage="缓冲区已刷新！请查看输出通道以获取更多详细信息"
					/>
				</div>
			)}
		</div>
		...
		return (
			<BaseRemoteConfigSection renderSectionHeader={renderSectionHeader}>
				<div className="flex flex-col justify-center gap-4">
					<h3>您已选择退出远程配置。重新选择加入以应用并在此处查看。</h3>
		...
		return (
			<BaseRemoteConfigSection renderSectionHeader={renderSectionHeader}>
				<div className="flex flex-col justify-center gap-4">
					<h3>
						您尚未配置远程配置。请通过我们的{" "}
						<VSCodeLink href="https://app.cline.bot/dashboard/organization?tab=settings">控制台</VSCodeLink>进行配置。
					</h3>
